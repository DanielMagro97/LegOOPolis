#include "../Buildings/TwoStoreyHouse.h"
#include "TwoStoreyHouseBuilder.h"
#include "NotEnoughPiecesException.h"

Building* TwoStoreyHouseBuilder::buildTwoStoreyHouse(Quarry *quarry) {

    Building *building = new TwoStoreyHouse();
